...
- [x] **AUTH-02**: All write endpoints (watchlist, shortlist, squad plan, profile) are gated by role-based permissions
...
- [x] **CRUD-09**: User's Recent Activity (searches, viewed players) is recorded and retrievable
- [x] **CRUD-10**: User can export a Shortlist or Club report as CSV
...
| AI-04 | Phase 10 | In progress (foundation + generator built in 10-01/10-02; end-to-end endpoint lands in 10-04) |

...
- [ ] **DATA-02**: Real club data (league, country, manager, formation, squad size, playing style) is migrated into Postgres
...
|-------------|-------|--------|
| DATA-01 | Phase 1 | In Progress (Plan 1/9 done) |
| DATA-02 | Phase 1 | In Progress (Plan 1/9 done) |
| DATA-03 | Phase 1 | In Progress (Plan 1/9 done) |
| DATA-04 | Phase 1 | In Progress (Plan 1/9 done) |
| DATA-05 | Phase 1 | In Progress (Plan 1/9 done) |
